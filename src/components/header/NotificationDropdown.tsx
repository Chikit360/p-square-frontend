  ...
  return (
    <div className="relative">
      ...
      >
        ...
        >
          <span className="absolute inline-flex w-full h-full bg-orange-400 rounded-full opacity-75 animate-ping">{"2"}</span>
        </span> */}
        <svg
...

          {
            loading ? (
              <div className="flex items-center justify-center w-full h-full">
                <svg
                  className="w-6 h-6 animate-spin text-gray-200 dark:text-gray-600"
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
                >
