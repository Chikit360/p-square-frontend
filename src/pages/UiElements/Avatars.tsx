...
export default function Avatars() {
  return (
    <>
      <PageMeta
        title="React.js Avatars Dashboard | Chikit-Thundergits - React.js Admin Dashboard Template"
        description="This is React.js Avatars Dashboard page for Chikit-Thundergits - React.js Tailwind CSS Admin Dashboard Template"
      />
