...
export default function Videos() {
  return (
    <>
      <PageMeta
        title="React.js Videos Tabs | Chikit-Thundergits - React.js Admin Dashboard Template"
        description="This is React.js Videos page for Chikit-Thundergits - React.js Tailwind CSS Admin Dashboard Template"
      />
