...
export default function Badges() {
  return (
    <div>
      <PageMeta
        title="React.js Badges Dashboard | Chikit-Thundergits - React.js Admin Dashboard Template"
        description="This is React.js Badges Dashboard page for Chikit-Thundergits - React.js Tailwind CSS Admin Dashboard Template"
      />
